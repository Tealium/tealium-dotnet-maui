...
namespace Tealium
{
    ...
    public sealed class TealiumConfig
    {
        ...
        /// <summary>
        /// Overrides just the profile used by Collect URL
        /// </summary>
        public string? OverrideCollectProfile { get; set; }
        ...
        /// <param name="overrideCollectProfile">Optional - Optional - Overrides the default destination profile only for the Collect Dispatcher</param>
     ...
     )
        {
            ...
            OverrideCollectProfile = overrideCollectProfile;
