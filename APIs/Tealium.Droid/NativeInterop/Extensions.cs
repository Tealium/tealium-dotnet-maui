...
namespace Tealium.Droid.NativeInterop.Extensions
{
    ...
    public static class ConfigExtensions
    {
        ...
        public static Com.Tealium.Core.TealiumConfig ToNativeConfig(this TealiumConfig config, Application application)
        {
            ...
            if (config.OverrideCollectProfile != null)
            {
                Com.Tealium.Collectdispatcher.TealiumConfigCollectDispatcherKt.SetOverrideCollectProfile(nativeConfig, config.OverrideCollectProfile);
            }
