...
namespace Tealium.iOS
{
    ...
    public class TealiumIOSImpl : ITealium
    {
        ...
        public void GetTagManagementWebView(Action<WKWebView> callback) {
            nativeTealium.GetWebView(callback);
        }
        ...
        public void GatherTrackData(Action<IDictionary<string, object>> callback)
        {
            nativeTealium.GatherTrackData( dictionary =>
            {
                var obj = NSObjectConverter.ConvertFromNSDictionaryToTargetType<object>(dictionary);
                callback?.Invoke(obj);
            });
        }
