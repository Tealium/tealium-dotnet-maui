...
namespace Tealium.RemoteCommands.Firebase
{
    ...
    public abstract class FirebaseRemoteCommand : IRemoteCommand
    {
        ...
        /// and Android on .NET MAUI. Empty constructor will use the 
        ...
        /// Initializes a new instance of the <see cref="T:Tealium.RemoteCommands.Firebase.FirebaseRemoteCommand"/> class.
        /// Pre-built Remote Command supporting Firebase Analytics for both iOS
        /// and Android on .NET MAUI. Supply a commmand id and description to 
        ...
        /// A comma separated list of command names as set out in the <see cref="FirebaseConstants.Commands"/>
        /// class is required at the paylod key <see cref="FirebaseConstants.KeyCommandName"/>
        /// </summary>
