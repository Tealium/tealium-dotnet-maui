...
namespace TealiumMauiExample.ViewModels
{
    public class AboutViewModel : BaseViewModel
    {
        public AboutViewModel()
        {
            ...
            GatherTrackDataCommand = new Command(() =>
            {
                Teal.Helper.DefaultInstance.GatherTrackData(data => {
                    foreach (var entry in data)
                    {
                        System.Diagnostics.Debug.WriteLine($"key ({entry.Key}) - value: {Stringify(entry.Value)}");
                    }
        ...
        public ICommand GatherTrackDataCommand { get; }
